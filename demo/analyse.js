...
var fs = require("fs");
var folder = "merged";
function analyseEntities(content) {
    return __awaiter(this, void 0, void 0, function () {
        var client, result, entities, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client.analyzeEntities({
                            document: {
                                content: content,
                                type: "PLAIN_TEXT",
                            },
                ...
                case 2:
                    ...
                    entities.forEach(function (entity) {
                        ...
                        if (entity.metadata && entity.metadata.wikipedia_url) {
                            console.log(" - Wikipedia URL: ".concat(entity.metadata.wikipedia_url));
                        }
                    });
                    return [3 /*break*/, 4];
                case 3:
